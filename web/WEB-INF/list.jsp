        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-center">
                        <a href="write"><button class="btn btn-primary btn-lg btn-block">글쓰기</button></a></p>
                    ...
                    <div class="well">
                        <ul class="pagination">
                            ...
                            <li ${pageMaker.pageDTO.page == num ? "class='active'":""}>
                                <a href="list?page=${num}&size=${pageMaker.pageDTO.size}">${num}</a></li>
                            </c:forEach>
